...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Telerik.XamarinForms.ChartRenderer.Android.DateTimeContinuousAxisLabelFormatter, Telerik.XamarinForms.Chart", DateTimeContinuousAxisLabelFormatter.class, __md_methods);
	}
	...
	public DateTimeContinuousAxisLabelFormatter ()
	{
		...
		if (getClass () == DateTimeContinuousAxisLabelFormatter.class)
			mono.android.TypeManager.Activate ("Telerik.XamarinForms.ChartRenderer.Android.DateTimeContinuousAxisLabelFormatter, Telerik.XamarinForms.Chart", "", this, new java.lang.Object[] {  });
	}
