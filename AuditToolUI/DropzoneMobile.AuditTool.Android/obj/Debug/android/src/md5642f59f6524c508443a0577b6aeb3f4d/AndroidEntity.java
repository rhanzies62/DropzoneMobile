...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Telerik.XamarinForms.InputRenderer.Android.DataForm.AndroidEntity, Telerik.XamarinForms.Input", AndroidEntity.class, __md_methods);
	}
	...
	public AndroidEntity ()
	{
		...
		if (getClass () == AndroidEntity.class)
			mono.android.TypeManager.Activate ("Telerik.XamarinForms.InputRenderer.Android.DataForm.AndroidEntity, Telerik.XamarinForms.Input", "", this, new java.lang.Object[] {  });
	}
