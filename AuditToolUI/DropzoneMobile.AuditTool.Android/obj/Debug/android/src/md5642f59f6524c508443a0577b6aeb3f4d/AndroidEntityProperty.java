...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Telerik.XamarinForms.InputRenderer.Android.DataForm.AndroidEntityProperty, Telerik.XamarinForms.Input", AndroidEntityProperty.class, __md_methods);
	}
	...
	public AndroidEntityProperty ()
	{
		...
		if (getClass () == AndroidEntityProperty.class)
			mono.android.TypeManager.Activate ("Telerik.XamarinForms.InputRenderer.Android.DataForm.AndroidEntityProperty, Telerik.XamarinForms.Input", "", this, new java.lang.Object[] {  });
	}
